...
hist(carp.degree$numsites, xlab= "Number of readers visited per carp", main=NULL, cex.lab=1.5, cex.axis=1.5)
...
hist(reader.degree$numcarp, xlab="Number of carp caotured by each reader", main=NULL, cex.lab=1.5, cex.axis=1.5)
...
for(i in 1:num_days){
  ...
  if(length(sub_ID)>1)
  {
     edgelist[[i]]<-data.frame(PIT=sub_combined$PIT, Location=sub_combined$site)
  }
}
