...
A<-ggplot(n, aes(x = x, y = y, xend = xend, yend = yend)) +
  ...
  geom_nodes(aes(color = top20, size = weight)) +
...
### Suplementary Figure 2. Diel cycle
...
ggplot(superfeeder_length, aes(x=as.factor(top20), y=Length))+
  geom_boxplot()+
...
```
### Supplemental Figure 6. Superfeeding results for 2019
...
```
### Lorenz Curves and Gini Coefficients for 2019 & 2020 Seasons
```{r}
